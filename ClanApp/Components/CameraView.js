...
import ChatTextInput from './Screens/StackScreen/ChatRoomScreen/ChatTextInput';
import {getStatusModel} from './Src/Utility/helperModels';
import {createUserStatus} from './Src/Api/APIController';
import {showToast} from './Src/Utility/helperFunctions';
import {Root, Button, Icon} from 'native-base';
import {GREEN, WHITE, TINT_LOAD_GRAY, TINT_DARK_GRAY} from './Src/Utility/colors';
import {uploadStatus} from './Screens/TabScreens/status/StatusActions';
...
import {
  ...
  TOGGLE_CAMERA,
  TOGGLE_FLASH,
} from './Screens/TabScreens/status/StatusReducer';
import {TINT_GRAY} from './Screens/TabScreens/statusDetails/utils/colors';
